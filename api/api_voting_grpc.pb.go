...
func (c *votingServiceClient) CandidateInfo(ctx context.Context, in *CandidateInfoRequest, opts ...grpc.CallOption) (*CandidateInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, VotingService_CandidateInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *votingServiceClient) RewardSources(ctx context.Context, in *RewardSourcesRequest, opts ...grpc.CallOption) (*RewardSourcesResponse, error) {
	...
	err := c.cc.Invoke(ctx, VotingService_RewardSources_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *votingServiceClient) VotingMeta(ctx context.Context, in *VotingMetaRequest, opts ...grpc.CallOption) (*VotingMetaResponse, error) {
	...
	err := c.cc.Invoke(ctx, VotingService_VotingMeta_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _VotingService_CandidateInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VotingService_CandidateInfo_FullMethodName,
	}
...
func _VotingService_RewardSources_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VotingService_RewardSources_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VotingService_VotingMeta_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VotingService_VotingMeta_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

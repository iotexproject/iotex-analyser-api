...
var (
	...
	gql__type_HermesBucketResponse                        *graphql.Object      // message HermesBucketResponse in api_hermes.proto
	gql__type_HermesBucketDistribution                    *graphql.Object      // message HermesBucketDistribution in api_hermes.proto
	...
	gql__type_BucketRewardDistribution                    *graphql.Object      // message BucketRewardDistribution in api_hermes.proto
	...
	gql__input_HermesBucketResponse                       *graphql.InputObject // message HermesBucketResponse in api_hermes.proto
	gql__input_HermesBucketDistribution                   *graphql.InputObject // message HermesBucketDistribution in api_hermes.proto
	...
	gql__input_BucketRewardDistribution                   *graphql.InputObject // message BucketRewardDistribution in api_hermes.proto
)
...
func Gql__type_HermesBucketResponse() *graphql.Object {
	if gql__type_HermesBucketResponse == nil {
		gql__type_HermesBucketResponse = graphql.NewObject(graphql.ObjectConfig{
			Name: "Api_Type_HermesBucketResponse",
			Fields: graphql.Fields{
				"hermesBucketDistribution": &graphql.Field{
					Type: graphql.NewList(Gql__type_HermesBucketDistribution()),
				},
			},
		})
	}
	return gql__type_HermesBucketResponse
}

func Gql__type_HermesBucketDistribution() *graphql.Object {
	if gql__type_HermesBucketDistribution == nil {
		gql__type_HermesBucketDistribution = graphql.NewObject(graphql.ObjectConfig{
			Name: "Api_Type_HermesBucketDistribution",
			Fields: graphql.Fields{
				"delegateName": &graphql.Field{
					Type: graphql.String,
				},
				"bucketRewardDistribution": &graphql.Field{
					Type: graphql.NewList(Gql__type_BucketRewardDistribution()),
				},
				"stakingIotexAddress": &graphql.Field{
					Type: graphql.String,
				},
	...
	return gql__type_HermesBucketDistribution
}
...
func Gql__type_BucketRewardDistribution() *graphql.Object {
	if gql__type_BucketRewardDistribution == nil {
		gql__type_BucketRewardDistribution = graphql.NewObject(graphql.ObjectConfig{
			Name: "Api_Type_BucketRewardDistribution",
			Fields: graphql.Fields{
				"voterEthAddress": &graphql.Field{
					Type: graphql.String,
				},
	...
	return gql__type_BucketRewardDistribution
}
...
func Gql__input_HermesBucketResponse() *graphql.InputObject {
	if gql__input_HermesBucketResponse == nil {
		gql__input_HermesBucketResponse = graphql.NewInputObject(graphql.InputObjectConfig{
			Name: "Api_Input_HermesBucketResponse",
			Fields: graphql.InputObjectConfigFieldMap{
				"hermesBucketDistribution": &graphql.InputObjectFieldConfig{
					Type: graphql.NewList(Gql__input_HermesBucketDistribution()),
				},
			},
		})
	}
	return gql__input_HermesBucketResponse
}

func Gql__input_HermesBucketDistribution() *graphql.InputObject {
	if gql__input_HermesBucketDistribution == nil {
		gql__input_HermesBucketDistribution = graphql.NewInputObject(graphql.InputObjectConfig{
			Name: "Api_Input_HermesBucketDistribution",
			Fields: graphql.InputObjectConfigFieldMap{
				"delegateName": &graphql.InputObjectFieldConfig{
					Type: graphql.String,
				},
				"bucketRewardDistribution": &graphql.InputObjectFieldConfig{
					Type: graphql.NewList(Gql__input_BucketRewardDistribution()),
				},
				"stakingIotexAddress": &graphql.InputObjectFieldConfig{
					Type: graphql.String,
				},
	...
	return gql__input_HermesBucketDistribution
}
...
func Gql__input_BucketRewardDistribution() *graphql.InputObject {
	if gql__input_BucketRewardDistribution == nil {
		gql__input_BucketRewardDistribution = graphql.NewInputObject(graphql.InputObjectConfig{
			Name: "Api_Input_BucketRewardDistribution",
			Fields: graphql.InputObjectConfigFieldMap{
				"voterEthAddress": &graphql.InputObjectFieldConfig{
					Type: graphql.String,
				},
	...
	return gql__input_BucketRewardDistribution
}
...
func (x *graphql__resolver_HermesService) GetQueries(conn *grpc.ClientConn) graphql.Fields {
	return graphql.Fields{
		...
		"HermesBucket": &graphql.Field{
			Type: Gql__type_HermesBucketResponse(),
			Args: graphql.FieldConfigArgument{
				"startEpoch": &graphql.ArgumentConfig{
					Type: graphql.Int,
				},
			...
			Resolve: func(p graphql.ResolveParams) (interface{}, error) {
				var req HermesRequest
				if err := runtime.MarshalRequest(p.Args, &req, false); err != nil {
					return nil, errors.Wrap(err, "Failed to marshal request for HermesBucket")
				}
				client := NewHermesServiceClient(conn)
				resp, err := client.HermesBucket(p.Context, &req)
				if err != nil {
					return nil, errors.Wrap(err, "Failed to call RPC HermesBucket")
				}
				return resp, nil
			},
		},

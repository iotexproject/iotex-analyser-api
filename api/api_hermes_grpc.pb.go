...
const (
	HermesService_Hermes_FullMethodName             = "/api.HermesService/Hermes"
	HermesService_HermesBucket_FullMethodName       = "/api.HermesService/HermesBucket"
	HermesService_HermesByVoter_FullMethodName      = "/api.HermesService/HermesByVoter"
	HermesService_HermesByDelegate_FullMethodName   = "/api.HermesService/HermesByDelegate"
	HermesService_HermesMeta_FullMethodName         = "/api.HermesService/HermesMeta"
	HermesService_HermesAverageStats_FullMethodName = "/api.HermesService/HermesAverageStats"
	HermesService_HermesDropRecords_FullMethodName  = "/api.HermesService/HermesDropRecords"
)
...
func (c *hermesServiceClient) Hermes(ctx context.Context, in *HermesRequest, opts ...grpc.CallOption) (*HermesResponse, error) {
	...
	err := c.cc.Invoke(ctx, HermesService_Hermes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hermesServiceClient) HermesBucket(ctx context.Context, in *HermesRequest, opts ...grpc.CallOption) (*HermesBucketResponse, error) {
	...
	err := c.cc.Invoke(ctx, HermesService_HermesBucket_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hermesServiceClient) HermesByVoter(ctx context.Context, in *HermesByVoterRequest, opts ...grpc.CallOption) (*HermesByVoterResponse, error) {
	...
	err := c.cc.Invoke(ctx, HermesService_HermesByVoter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hermesServiceClient) HermesByDelegate(ctx context.Context, in *HermesByDelegateRequest, opts ...grpc.CallOption) (*HermesByDelegateResponse, error) {
	...
	err := c.cc.Invoke(ctx, HermesService_HermesByDelegate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hermesServiceClient) HermesMeta(ctx context.Context, in *HermesMetaRequest, opts ...grpc.CallOption) (*HermesMetaResponse, error) {
	...
	err := c.cc.Invoke(ctx, HermesService_HermesMeta_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hermesServiceClient) HermesAverageStats(ctx context.Context, in *HermesAverageStatsRequest, opts ...grpc.CallOption) (*HermesAverageStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, HermesService_HermesAverageStats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hermesServiceClient) HermesDropRecords(ctx context.Context, in *HermesDropRecordsRequest, opts ...grpc.CallOption) (*HermesDropRecordsResponse, error) {
	...
	err := c.cc.Invoke(ctx, HermesService_HermesDropRecords_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HermesService_Hermes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HermesService_Hermes_FullMethodName,
	}
...
func _HermesService_HermesBucket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HermesService_HermesBucket_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HermesService_HermesByVoter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HermesService_HermesByVoter_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HermesService_HermesByDelegate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HermesService_HermesByDelegate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HermesService_HermesMeta_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HermesService_HermesMeta_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HermesService_HermesAverageStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HermesService_HermesAverageStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HermesService_HermesDropRecords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HermesService_HermesDropRecords_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

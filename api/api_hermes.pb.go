...
type HermesRequest struct {
	...
	RewardAddress []string `protobuf:"bytes,3,rep,name=rewardAddress,proto3" json:"rewardAddress,omitempty"` //Name of reward address
}
...
type BucketRewardDistribution struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	VoterEthAddress   string `protobuf:"bytes,1,opt,name=voterEthAddress,proto3" json:"voterEthAddress,omitempty"`     // voter’s ERC20 address
	VoterIotexAddress string `protobuf:"bytes,2,opt,name=voterIotexAddress,proto3" json:"voterIotexAddress,omitempty"` // voter’s IoTeX address
	BucketID          uint64 `protobuf:"varint,3,opt,name=bucketID,proto3" json:"bucketID,omitempty"`                  // voter's bucketID
	Amount            string `protobuf:"bytes,4,opt,name=amount,proto3" json:"amount,omitempty"`                       // amount of reward distribution
}

func (x *BucketRewardDistribution) Reset() {
	*x = BucketRewardDistribution{}
	if protoimpl.UnsafeEnabled {
...
func (x *BucketRewardDistribution) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BucketRewardDistribution) ProtoMessage() {}

func (x *BucketRewardDistribution) ProtoReflect() protoreflect.Message {
	mi := &file_api_hermes_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BucketRewardDistribution.ProtoReflect.Descriptor instead.
func (*BucketRewardDistribution) Descriptor() ([]byte, []int) {
	return file_api_hermes_proto_rawDescGZIP(), []int{4}
}

func (x *BucketRewardDistribution) GetVoterEthAddress() string {
	if x != nil {
		return x.VoterEthAddress
	}
	return ""
...
func (x *BucketRewardDistribution) GetVoterIotexAddress() string {
	if x != nil {
		return x.VoterIotexAddress
	}
	return ""
...
func (x *BucketRewardDistribution) GetBucketID() uint64 {
	if x != nil {
		return x.BucketID
	}
	return 0
...
func (x *BucketRewardDistribution) GetAmount() string {
	if x != nil {
		return x.Amount
	}
	return ""
...
type HermesBucketDistribution struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DelegateName             string                      `protobuf:"bytes,1,opt,name=delegateName,proto3" json:"delegateName,omitempty"` // delegate name
	BucketRewardDistribution []*BucketRewardDistribution `protobuf:"bytes,2,rep,name=bucketRewardDistribution,proto3" json:"bucketRewardDistribution,omitempty"`
	StakingIotexAddress      string                      `protobuf:"bytes,3,opt,name=stakingIotexAddress,proto3" json:"stakingIotexAddress,omitempty"` // delegate IoTeX staking address
	VoterCount               uint64                      `protobuf:"varint,4,opt,name=voterCount,proto3" json:"voterCount,omitempty"`                  // number of voters
	WaiveServiceFee          bool                        `protobuf:"varint,5,opt,name=waiveServiceFee,proto3" json:"waiveServiceFee,omitempty"`        // whether the delegate is qualified for waiving the service fee
	Refund                   string                      `protobuf:"bytes,6,opt,name=refund,proto3" json:"refund,omitempty"`                           // amount of refund
...
func (x *HermesBucketDistribution) Reset() {
	*x = HermesBucketDistribution{}
	if protoimpl.UnsafeEnabled {
...
func (x *HermesBucketDistribution) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HermesBucketDistribution) ProtoMessage() {}

func (x *HermesBucketDistribution) ProtoReflect() protoreflect.Message {
	mi := &file_api_hermes_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HermesBucketDistribution.ProtoReflect.Descriptor instead.
func (*HermesBucketDistribution) Descriptor() ([]byte, []int) {
	return file_api_hermes_proto_rawDescGZIP(), []int{5}
}

func (x *HermesBucketDistribution) GetDelegateName() string {
	if x != nil {
		return x.DelegateName
	}
	return ""
...
func (x *HermesBucketDistribution) GetBucketRewardDistribution() []*BucketRewardDistribution {
	if x != nil {
		return x.BucketRewardDistribution
	}
	return nil
}

func (x *HermesBucketDistribution) GetStakingIotexAddress() string {
	if x != nil {
		return x.StakingIotexAddress
	}
	return ""
...
func (x *HermesBucketDistribution) GetVoterCount() uint64 {
	if x != nil {
		return x.VoterCount
	}
	return 0
...
func (x *HermesBucketDistribution) GetWaiveServiceFee() bool {
	if x != nil {
		return x.WaiveServiceFee
	}
	return false
...
func (x *HermesBucketDistribution) GetRefund() string {
	if x != nil {
		return x.Refund
	}
	return ""
...
type HermesBucketResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	HermesBucketDistribution []*HermesBucketDistribution `protobuf:"bytes,1,rep,name=hermesBucketDistribution,proto3" json:"hermesBucketDistribution,omitempty"`
}

func (x *HermesBucketResponse) Reset() {
	*x = HermesBucketResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *HermesBucketResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HermesBucketResponse) ProtoMessage() {}

func (x *HermesBucketResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_hermes_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HermesBucketResponse.ProtoReflect.Descriptor instead.
func (*HermesBucketResponse) Descriptor() ([]byte, []int) {
	return file_api_hermes_proto_rawDescGZIP(), []int{6}
}

func (x *HermesBucketResponse) GetHermesBucketDistribution() []*HermesBucketDistribution {
	if x != nil {
		return x.HermesBucketDistribution
	}
	return nil
}
...
func (*HermesAverageStatsResponse) Descriptor() ([]byte, []int) {
	return file_api_hermes_proto_rawDescGZIP(), []int{16}
}
...
func (*HermesDropRecordsRequest) Descriptor() ([]byte, []int) {
	return file_api_hermes_proto_rawDescGZIP(), []int{17}
}
...
func (x *HermesDropRecordsResponse) Reset() {
	*x = HermesDropRecordsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_hermes_proto_msgTypes[18]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HermesDropRecordsResponse) Descriptor() ([]byte, []int) {
	return file_api_hermes_proto_rawDescGZIP(), []int{18}
}
...
func (x *HermesByVoterResponse_Delegate) Reset() {
	*x = HermesByVoterResponse_Delegate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_hermes_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HermesByVoterResponse_Delegate) Descriptor() ([]byte, []int) {
	return file_api_hermes_proto_rawDescGZIP(), []int{8, 0}
}
...
func (x *HermesAverageStatsResponse_AveragePerEpoch) Reset() {
	*x = HermesAverageStatsResponse_AveragePerEpoch{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_hermes_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HermesAverageStatsResponse_AveragePerEpoch) Descriptor() ([]byte, []int) {
	return file_api_hermes_proto_rawDescGZIP(), []int{16, 0}
}
...
var file_api_hermes_proto_rawDesc = []byte{
	...
	0x64, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0d,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xa5, 0x02,
	0x0a, 0x1a, 0x48, 0x65, 0x72, 0x6d, 0x65, 0x73, 0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x53,
	...
	,
	...
	0x6d, 0x62, 0x65, 0x72, 0x12, 0x22, 0x0a, 0x0c, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x65,
	0x4e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x64, 0x65, 0x6c, 0x65,
	0x67, 0x61, 0x74, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x22, 0x0a, 0x0c, 0x76, 0x6f, 0x74, 0x65,
	...
	,
...
var file_api_hermes_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_api_hermes_proto_goTypes = []interface{}{
	...
	(*BucketRewardDistribution)(nil),                   // 4: api.BucketRewardDistribution
	(*HermesBucketDistribution)(nil),                   // 5: api.HermesBucketDistribution
	(*HermesBucketResponse)(nil),                       // 6: api.HermesBucketResponse
	(*HermesByVoterRequest)(nil),                       // 7: api.HermesByVoterRequest
	(*HermesByVoterResponse)(nil),                      // 8: api.HermesByVoterResponse
	(*HermesByDelegateRequest)(nil),                    // 9: api.HermesByDelegateRequest
	(*HermesByDelegateVoterInfo)(nil),                  // 10: api.HermesByDelegateVoterInfo
	(*HermesByDelegateDistributionRatio)(nil),          // 11: api.HermesByDelegateDistributionRatio
	(*HermesByDelegateResponse)(nil),                   // 12: api.HermesByDelegateResponse
	(*HermesMetaRequest)(nil),                          // 13: api.HermesMetaRequest
	(*HermesMetaResponse)(nil),                         // 14: api.HermesMetaResponse
	(*HermesAverageStatsRequest)(nil),                  // 15: api.HermesAverageStatsRequest
	(*HermesAverageStatsResponse)(nil),                 // 16: api.HermesAverageStatsResponse
	(*HermesDropRecordsRequest)(nil),                   // 17: api.HermesDropRecordsRequest
	(*HermesDropRecordsResponse)(nil),                  // 18: api.HermesDropRecordsResponse
	(*HermesByVoterResponse_Delegate)(nil),             // 19: api.HermesByVoterResponse.Delegate
	(*HermesAverageStatsResponse_AveragePerEpoch)(nil), // 20: api.HermesAverageStatsResponse.AveragePerEpoch
...
var file_api_hermes_proto_depIdxs = []int32{
	...
	4,  // 2: api.HermesBucketDistribution.bucketRewardDistribution:type_name -> api.BucketRewardDistribution
	5,  // 3: api.HermesBucketResponse.hermesBucketDistribution:type_name -> api.HermesBucketDistribution
	21, // 4: api.HermesByVoterRequest.pagination:type_name -> pagination.Pagination
	19, // 5: api.HermesByVoterResponse.delegates:type_name -> api.HermesByVoterResponse.Delegate
	21, // 6: api.HermesByDelegateRequest.pagination:type_name -> pagination.Pagination
	10, // 7: api.HermesByDelegateResponse.voterInfoList:type_name -> api.HermesByDelegateVoterInfo
	11, // 8: api.HermesByDelegateResponse.distributionRatio:type_name -> api.HermesByDelegateDistributionRatio
	20, // 9: api.HermesAverageStatsResponse.averagePerEpoch:type_name -> api.HermesAverageStatsResponse.AveragePerEpoch
	0,  // 10: api.HermesService.Hermes:input_type -> api.HermesRequest
	0,  // 11: api.HermesService.HermesBucket:input_type -> api.HermesRequest
	7,  // 12: api.HermesService.HermesByVoter:input_type -> api.HermesByVoterRequest
	9,  // 13: api.HermesService.HermesByDelegate:input_type -> api.HermesByDelegateRequest
	13, // 14: api.HermesService.HermesMeta:input_type -> api.HermesMetaRequest
	15, // 15: api.HermesService.HermesAverageStats:input_type -> api.HermesAverageStatsRequest
	17, // 16: api.HermesService.HermesDropRecords:input_type -> api.HermesDropRecordsRequest
	3,  // 17: api.HermesService.Hermes:output_type -> api.HermesResponse
	6,  // 18: api.HermesService.HermesBucket:output_type -> api.HermesBucketResponse
	8,  // 19: api.HermesService.HermesByVoter:output_type -> api.HermesByVoterResponse
	12, // 20: api.HermesService.HermesByDelegate:output_type -> api.HermesByDelegateResponse
	14, // 21: api.HermesService.HermesMeta:output_type -> api.HermesMetaResponse
	16, // 22: api.HermesService.HermesAverageStats:output_type -> api.HermesAverageStatsResponse
	18, // 23: api.HermesService.HermesDropRecords:output_type -> api.HermesDropRecordsResponse
...
func file_api_hermes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_hermes_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BucketRewardDistribution); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_hermes_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HermesBucketDistribution); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_hermes_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HermesBucketResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_hermes_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_hermes_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_hermes_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
